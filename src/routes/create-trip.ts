    ...
    const message = await mail.sendMail({
      ...
      html: `
        <div style="font-family: sans-serif; font-size: 16px; line-height: 160%">
          <p>Você solicitou a criação de uma viagem para <strong>${destination}</strong> nas datas de <strong>${formatedStartDate}</strong> até <strong>${formatedEndDate}</strong></strong></p>
          <p></p>
